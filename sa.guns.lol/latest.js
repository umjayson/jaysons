/* Simple Analytics - Privacy friendly analytics (docs.simpleanalytics.com/script; 2023-05-03; b8c6; v11) */
...
!(function (l, t, e, n, p) {
  try {
    ...
    var pt = function (e, t, n) {
      ...
      ft = ht || v,
      dt = { version: "custom_latest_11", hostname: ft };
    (n = function (t) {
    ...
    if (
      ((qt.sri = d),
      D && ((qt.mobile = D.mobile), (qt.brands = S(D.brands))),
      y.doctype || p("Add DOCTYPE html for accurate dimensions"),
      ft !== v && (qt.hostname_original = v),
      !_t && c in g && "1" == g[c])
    )
    ...
    var $t,
      ...
      Rt = function (t, e) {
        var n;
        At &&
          ((n = Z(dt, { type: "append", original_id: e ? t : qt.page_id })),
          tt("t") && (n.duration = Math.round((et() - gt - Ht) / 1e3)),
          (Ht = 0),
          (gt = et()),
    ...
    M(
      "visibilitychange",
      function () {
        y.hidden ? ("on" + P in l || Rt(), (jt = et())) : (Ht += et() - jt);
      },
      d
    ),
      M(P, Rt, d);
    var Pt = y.body || {},
      Tt = function () {
        try {
          ...
          return Math.min(
            100,
            5 * Math.round((100 * ((A.scrollTop || 0) + t)) / e / 5)
          );
        } catch (ne) {
          return p(ne), 0;
        }
      ...
      Nt = function (t, e, n) {
        ...
        if (r && $t != r) {
          ($t = r),
            ...
            tt("v") &&
              ((Dt.viewport_width =
                Math.max(A.clientWidth || 0, l.innerWidth || 0) || null),
              (Dt.viewport_height =
                Math.max(A[R] || 0, l.innerHeight || 0) || null)),
            tt("l") && g[q] && (Dt[q] = g[q]),
            N &&
              tt("sc") &&
          ...
          var s = function () {
            (E = f),
              (function (t, e, n, r) {
                t && Rt("" + qt.page_id, f), At && (qt.page_id = nt());
                var a = ft + Bt();
                pt({
                  id: qt.page_id,
                  type: m,
            ...
            try {
              D && rt(D.getHighEntropyValues)
                ? D.getHighEntropyValues([T, U])
                    .then(function (t) {
                      (qt.os_name = t[T]), (qt.os_version = t[U]), s();
                    })
                    ["catch"](s)
                : s();
            } catch (u) {
