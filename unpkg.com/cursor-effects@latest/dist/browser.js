  ...
  return (
        ...
        !(function () {
          ...
          (function () {
            ...
            for (let t = 0; t < T.length; t++)
              (T[t].y =
                S[F.length + t] + 45 * Math.sin((t * B * Math.PI) / 180)),
                (T[t].x =
                  Y[F.length + t] + 45 * Math.cos((t * B * Math.PI) / 180)),
            ...
            for (let t = 0; t < X.length; t++)
              (X[t].y =
                S[F.length + E + D.length + t] + 0 + t * R * Math.sin(s)),
                (X[t].x =
                  Y[F.length + E + D.length + t] + 0 + t * R * Math.cos(s)),
                (n.fillStyle = X[t].color),
                n.fillText(X[t].value, X[t].x, X[t].y);
            for (let t = 0; t < I.length; t++)
              (I[t].y =
                S[F.length + E + D.length + X.length + t] +
                0 +
                t * R * Math.sin(i)),
                (I[t].x =
    ...
    (t.textFlag = function (t) {
      ...
      for (let t = 0; t < c.length; t++)
        m[t] = { letter: c.charAt(t), x: g / 2, y: g / 2 };
      t?.size;
