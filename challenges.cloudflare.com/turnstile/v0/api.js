...
(function () {
  ...
  function V(e, r) {
    return r != null && typeof Symbol != "undefined" && r[Symbol.hasInstance]
  ...
  function Fe(e) {
    for (var r = 1; r < arguments.length; r++) {
      ...
      typeof Object.getOwnPropertySymbols == "function" &&
        (o = o.concat(
          Object.getOwnPropertySymbols(n).filter(function (c) {
  ...
  function rt(e, r) {
    return (
      ...
      Object.getOwnPropertyDescriptors
        ...
        : Ar(Object(r)).forEach(function (n) {
  ...
  var Gt = {
    ...
    retryable: !1,
    description:
      "Turnstile's api.js was loaded, but the iframe under challenges.cloudflare.com could not be loaded. Has the visitor blocked some parts of challenges.cloudflare.com or are they self-hosting api.js?",
  };
  var Xt = 300020;
  var Ue = 300030;
  var Ve = 300031;
    ...
    if (
      (e.params._debugSitekeyOverrides &&
        (e.params._debugSitekeyOverrides.offlabel !== "default" &&
          r.set("offlabel", e.params._debugSitekeyOverrides.offlabel),
        e.params._debugSitekeyOverrides.clearance_level !== "default" &&
          r.set(
            "clearance_level",
            e.params._debugSitekeyOverrides.clearance_level
          )),
      r.size !== 0)
    )
      return r.toString();
  ...
  function wt(e, r, n, o, c, l, h) {
    ...
    return ""
      .concat(f, "/cdn-cgi/challenge-platform/")
      .concat(p, "turnstile/if/ov2/av0/rcv")
      .concat(o, "/")
      .concat(e, "/")
      .concat(r, "/")
      .concat(n.theme, "/")
  ...
  var Tt = function (e) {
      var r,
        n,
        o = window.innerWidth < 400,
        c =
          e.state === Se.FAILURE_FEEDBACK ||
          e.state === Se.FAILURE_HAVING_TROUBLES,
        l,
        h = L(
          Nr,
          (l =
            (r = e.displayLanguage) === null || r === void 0
              ? void 0
              : r.toLowerCase()) !== null && l !== void 0
            ? l
            : "nonexistent"
        ),
        f,
        p = L(
          kr,
          (f =
            (n = e.displayLanguage) === null || n === void 0
              ? void 0
              : n.toLowerCase()) !== null && f !== void 0
            ? f
            : "nonexistent"
        );
      return o
  ...
  function dr() {
    ...
    e ||
      g(
        "Could not find Turnstile script tag, some features may not be available",
        43777
      );
    var r = e.src,
      n = { loadedAsync: !1, params: new URLSearchParams(), src: r };
  ...
  var At = function (e, r) {
      var n = xt(r.params, !1),
        ...
        l,
        h = ""
          .concat(n, "/cdn-cgi/challenge-platform/")
          .concat(o, "feedback-reports/")
          .concat(qe(e), "/")
          .concat(r.displayLanguage, "/")
          .concat((c = r.params.theme) !== null && c !== void 0 ? c : r.theme);
      r.wrapper.parentNode ||
        g(
          "Cannot initialize Widget, Element not found (#".concat(e, ")."),
          3074
        );
      ...
      (s.className = "cf-turnstile-feedback"),
        (s.id = "cf-fr-id"),
        (s.style.width = "100vw"),
        (s.style.maxWidth = "450px"),
        (s.style.height = Tt(r)),
      ...
      (w.id = e + "-fr"),
        ...
        w.setAttribute("allow", "cross-origin-isolated; fullscreen"),
        w.setAttribute(
          "sandbox",
      ...
      I.setAttribute("stroke-width", "1"),
        I.setAttribute("stroke", "#999"),
        I.setAttribute("fill", "none"),
        I.setAttribute("x1", "6"),
        I.setAttribute("x2", "18"),
        I.setAttribute("y1", "18"),
        I.setAttribute("y2", "5"),
        T.appendChild(I);
      ...
      C.setAttribute("stroke-width", "1"),
        ...
        r.wrapper.parentNode.appendChild(f),
    ...
    fr = function (e) {
      var r, n, o;
      (o = document.getElementById(e)) === null ||
        o === void 0 ||
        (n = o.parentElement) === null ||
        n === void 0 ||
  ...
  function pr(e) {
    ...
    var r = function (n, o) {
      ...
      for (var c = 1, l = n.previousElementSibling; l; )
        l.tagName === n.tagName && c++, (l = l.previousElementSibling);
    ...
    if (typeof e != "string")
      throw new Error(
        "djb2: expected string, got ".concat(
          typeof e == "undefined" ? "undefined" : U(e)
        )
      );
  ...
  function Ur(e) {
    ...
    try {
      for (
        var c = e.widgetMap[Symbol.iterator](), l;
        !(r = (l = c.next()).done);
        r = !0
      ) {
        var h = Ae(l.value, 2),
          ...
          p = h[1],
          s;
        (p.watchcat.seq = e.watchCatSeq),
          p.watchcat.lastAckedSeq === 0 &&
            (p.watchcat.lastAckedSeq = e.watchCatSeq);
        var w = K(f);
        if (!w || !p.shadow) {
          p.watchcat.missingWidgetWarning ||
            (b(
            ...
            (p.watchcat.missingWidgetWarning = !0));
          continue;
        }
        ...
        if (!(p.isComplete || p.isFailed)) {
          ...
          if (
            ((p.isExecuting ||
              !p.isInitialized ||
              (p.isInitialized && !p.isStale && !p.isExecuted)) &&
              p.watchcat.lastAckedSeq !== 0 &&
              I) ||
            R
          ) {
          ...
          (s = T.contentWindow) === null ||
            s === void 0 ||
            s.postMessage(
              { source: P, widgetId: f, seq: e.watchCatSeq, event: "meow" },
              "*"
            );
        }
      }
  ...
  function Lt() {
    var e = [Jt, Zt];
    y.isRecaptchaCompatibilityMode && e.push(er),
  ...
  function Vr(e) {
    ...
    if (!(r === void 0 || r.hasResponseParamEl)) {
      ...
      var n,
        o = (n = r.params["response-field"]) !== null && n !== void 0 ? n : !0;
      if (o) {
        var c = document.createElement("input");
        c.type = "hidden";
        var l;
        (c.name =
          (l = r.params["response-field-name"]) !== null && l !== void 0
            ? l
            : _t),
        ...
        var h;
        if (
          typeof r.params["response-field-name"] != "string" &&
          wr((h = r.params.sitekey) !== null && h !== void 0 ? h : "")
        ) {
          var f = document.createElement("input");
          (f.type = "hidden"),
            (f.name = yt),
            (f.id = "".concat(e, "_legacy_response")),
            r.wrapper.appendChild(f);
        }
      }
      if (y.isRecaptchaCompatibilityMode) {
        ...
        (p.type = "hidden"),
          (p.name = bt),
          (p.id = "".concat(e, "_g_response")),
          r.wrapper.appendChild(p);
      }
    }
  }
  function xr(e, r) {
    ...
    if (
      (o !== null && V(o, HTMLInputElement) && (o.value = r),
      ...
      default:
        g(
          'Invalid value for parameter "mode", expected "'
            .concat(q.NON_INTERACTIVE, '", "')
            .concat(q.MANAGED, '" or "')
            .concat(q.INVISIBLE, '", got "')
            .concat(l, '"'),
          2818
        );
    }
  ...
  function Wr(e) {
    return e.origin
      ? e.origin === "https://challenges.cloudflare.com" ||
          e.origin === "https://challenges-staging.cloudflare.com"
      : !0;
  }
  function wr(e) {
  ...
  function br() {
    for (
      var e = window;
      e && e.top !== e && !e.location.href.startsWith("http");
  ...
  var Mt = (function () {
    var e = function (a, i, t, d) {
        ...
        if (a.params.retry === fe.AUTO || t) {
          ...
          var d,
            u = t
              ? 0
              : 1e3 * 2 +
                ((d = a.params["retry-interval"]) !== null && d !== void 0
                  ? d
                  : 0);
      ...
      n = function (a, i, t) {
        ...
        a.response === void 0 &&
          ...
          (d = a.cbSuccess) === null ||
            d === void 0 ||
            d.call(a, a.response, t);
      },
      o = function (a) {
        if (!a) return [];
        for (
          var i = a.attributes, t = i.length, d = new Array(t), u = 0;
          u < t;
          u++
        )
          d[u] = i[u].name;
      ...
      h = function (a) {
        ...
        try {
          for (
            var u = y.widgetMap[Symbol.iterator](), m;
            !(i = (m = u.next()).done);
            i = !0
          ) {
            var E = Ae(m.value, 2),
      ...
      f = function (a, i, t) {
        for (; a.msgQueue.length; ) {
          var d,
            u = a.msgQueue.pop();
          (d = t.contentWindow) === null ||
            d === void 0 ||
            d.postMessage({ source: P, widgetId: i, event: u }, "*");
        }
      },
      p = function (a, i) {
        if (i) {
          ...
          d.length !== 0 &&
            ...
            i["after-interactive-callback"] &&
              (a.cbAfterInteractive = i["after-interactive-callback"]),
            i["before-interactive-callback"] &&
              (a.cbBeforeInteractive = i["before-interactive-callback"]),
            ...
            i["unsupported-callback"] &&
              (a.cbUnsupported = i["unsupported-callback"]),
      ...
      s = function (a) {
        ...
        if (t) {
          ...
          (t.isResetting = !0),
            ...
            (t.watchcat.seq = 0),
            t.params.execution === pe.RENDER &&
              (t.msgQueue.push(oe.EXECUTE),
              (t.isExecuted = !0),
              (t.isExecuting = !0));
          var u = K(i),
            m = t.shadow.querySelector("#".concat(u));
          (!u || !m) &&
            g("Widget ".concat(i, " to reset was not found."), 3330),
            t.params.appearance === X.INTERACTION_ONLY && _r(m),
            t.params.sitekey === null &&
          ...
          (E.src = wt(
            ...
            t.params.sitekey,
            t.params,
            (x = t.rcV) !== null && x !== void 0 ? x : Y,
            !1,
            "b",
            ht(t)
          )),
            (d = m.parentNode) === null || d === void 0 || d.replaceChild(E, m),
            Ct(u),
      ...
      w = function (a) {
        ...
        var d = K(t),
          u = [
            "input#".concat(d, "_response"),
            "input#".concat(d, "_legacy_response"),
            "input#".concat(d, "_g_response"),
          ];
        ...
        m == null ||
          m.shadow.querySelectorAll(u.join(", ")).forEach(function (x) {
            return x.remove();
          }),
          m == null || m.wrapper.remove();
        var E =
          (i = y.widgetMap.get(t)) === null || i === void 0
            ? void 0
            : i.retryTimeout;
      ...
      T = function (a, i) {
        ...
        if (typeof a == "string")
          try {
            ...
            E || g('Unable to find a container for "'.concat(a, '"'), 3585),
              (m = E);
          } catch (Pt) {
            g(
        ...
        try {
          for (
            var F = y.widgetMap.values()[Symbol.iterator](), H;
            !(x = (H = F.next()).done);
            x = !0
          ) {
            var Z = H.value;
            if (m.contains(Z.wrapper)) {
              b(
                "Turnstile has already been rendered in this container. Did you mean to render it multiple times?"
              );
              break;
            }
          }
        ...
        if (D) {
          ...
          var re;
          v.execution =
            (re = v.execution) !== null && re !== void 0 ? re : pe.RENDER;
          var he;
          v.appearance =
            (he = v.appearance) !== null && he !== void 0 ? he : X.ALWAYS;
          var ne;
          v["retry-interval"] = Number(
            (ne = v["retry-interval"]) !== null && ne !== void 0 ? ne : tr
          );
          var ye;
          v["expiry-interval"] = Number(
            (ye = v["expiry-interval"]) !== null && ye !== void 0
              ? ye
              : (Qt - $t) * 1e3
          );
          var ue;
          ...
          typeof B != "string" &&
            g(
              'Invalid or missing type for parameter "sitekey", expected "string", got "'.concat(
                typeof B == "undefined" ? "undefined" : U(B),
                '"'
              ),
              3588
            ),
            Yt(B) ||
              g(
                'Invalid input for parameter "sitekey", got "'.concat(B, '"'),
                3589
              ),
            dt(v.size) ||
              g(
          ...
          var we,
            Q =
              (we = v["refresh-expired"]) !== null && we !== void 0
                ? we
                : $.AUTO;
          ft(Q)
            ? (v["refresh-expired"] = Q)
            : g(
                'Invalid type for parameter "refresh-expired", expected never|manual|auto, got "'
                  .concat(Q, '" ')
                  .concat(typeof Q == "undefined" ? "undefined" : U(Q)),
                3603
              );
          var Te,
            ae =
              (Te = v["refresh-timeout"]) !== null && Te !== void 0
                ? Te
                : ie.AUTO;
          pt(Q)
            ? (v["refresh-timeout"] = ae)
            : g(
                'Invalid type for parameter "refresh-timeout", expected never|manual|auto, got "'
                  .concat(ae, '" ')
                  .concat(typeof ae == "undefined" ? "undefined" : U(ae)),
                3603
              );
          var j = document.createElement("iframe"),
            se = document.createElement("div"),
            Dt = se.attachShadow({ mode: "closed" });
          ut(ge) ||
            g(
              'Invalid input for optional parameter "action", got "'.concat(
                ge,
          ...
          if (!(!Re || !de)) {
            ...
            $e || g("Turnstile Initialization Error ", 3606),
              (j.style.display = "none"),
              (j.style.border = "none"),
              (j.style.overflow = "hidden"),
              j.setAttribute("src", wt(Re, B, v, Y, !1, "b", ht($e))),
              (j.onerror = function () {
                if (G) {
            ...
            L(
              (Je =
                (d = document.featurePolicy) === null ||
                d === void 0 ||
                (t = d.features) === null ||
                t === void 0
                  ? void 0
                  : t.call(d)) !== null && Je !== void 0
                ? Je
                : [],
              Et
            ) && Vt.push(Et),
              j.setAttribute("allow", Vt.join("; ")),
              j.setAttribute(
                "sandbox",
              ...
              (j.id = de);
            var Ze;
            (j.tabIndex = (Ze = v.tabindex) !== null && Ze !== void 0 ? Ze : 0),
              (j.title = "Widget containing a Cloudflare security challenge"),
              Dt.appendChild(j);
            var et,
              Rr =
                (et = v["response-field"]) !== null && et !== void 0 ? et : !0;
            if (Rr) {
              ...
              if (
                ((Ne.name =
                  (tt = v["response-field-name"]) !== null && tt !== void 0
                    ? tt
                    : _t),
                (Ne.id = "".concat(de, "_response")),
                se.appendChild(Ne),
                typeof v["response-field-name"] != "string" && wr(B))
              ) {
      ...
      N = function () {
        ...
        try {
          for (
            var m = y.widgetMap[Symbol.iterator](), E;
            !(t = (E = m.next()).done);
            t = !0
          ) {
            var x = Ae(E.value, 2),
    ...
    function I() {
      return (
        (I = Ht(function (_, a, i, t) {
          var d, u, m, E, x, A, S, F, H, Z;
          return De(this, function (D) {
            switch (D.label) {
              case 0:
                if (((d = _.params.sitekey), (u = br()), !u))
                  return (
                    b(
                ...
                (m = "h/".concat("b", "/")),
                  ...
                  (S = ""
                    .concat(x, "://")
                    .concat(E.host, "/cdn-cgi/challenge-platform/")
                    .concat(m, "rc/")
                    .concat(t)
                    .concat(A)),
                  (D.label = 1);
                ...
                return (
                  ...
                  [
                    ...
                    fetch(S, {
                      ...
                      redirect: "manual",
                      body: JSON.stringify({ sitekey: d, secondaryToken: i }),
                    }),
                  ]
                );
              case 2:
              ...
              case 3:
                return [4, F.json()];
              case 4:
                if (((H = D.sent()), "status" in H && H.status === "redeemed"))
                  return n(_, a, !0), [2];
                D.label = 5;
              case 5:
                return [3, 7];
              case 6:
                return (
                  (Z = D.sent()),
                  b(
                    "Error contacting Turnstile, aborting clearance remdeption."
                  ),
                  n(_, a, !1),
                  [3, 7]
                );
            ...
            switch (a.event) {
              case "init": {
                ...
                u ||
                  ...
                  (t.nextRcV = a.nextRcV),
                  t.mode === q.INVISIBLE &&
                    t.params["refresh-expired"] === $.MANUAL &&
                    b(
                  ...
                  t.mode !== q.MANAGED &&
                    t.params["refresh-timeout"] !== ie.AUTO &&
                    b(
                      "setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."
                    ),
                  t.params.appearance === X.ALWAYS ||
                  (t.isExecuting && t.params.appearance === X.EXECUTE)
                    ? Nt(u, t)
                    : _r(u),
                  (u.style.display = "");
                ...
                m ||
                  g(
                    "Received state for an unknown widget: ".concat(a.widgetId),
                    3078
                  ),
                  (d = m.contentWindow) === null ||
                    d === void 0 ||
                    d.postMessage(
                      { source: P, widgetId: a.widgetId, event: "init" },
                      "*"
                    );
                break;
              }
              ...
              case "food": {
                t.watchcat &&
                  a.seq > t.watchcat.lastAckedSeq &&
                  (t.watchcat.lastAckedSeq = a.seq);
                break;
              }
              case "overrunBegin": {
                (t.isOverrunning = !0),
                  t.watchcat &&
                    (t.watchcat.overrunBeginSeq = t.watchcat.lastAckedSeq);
                break;
              }
              case "overrunEnd": {
                t.isOverrunning = !1;
              ...
              case "fail": {
                ...
                if (H) {
                  var Z,
                    D = t.shadow.querySelector("#".concat(i));
                  D == null ||
                    (Z = D.contentWindow) === null ||
                    Z === void 0 ||
                    Z.postMessage(
                      { source: P, widgetId: a.widgetId, event: "forceFail" },
                      "*"
                    );
                }
                if (F) {
                  var v;
                  F(String((v = a.code) !== null && v !== void 0 ? v : Xt))
                    ? t.params.retry === fe.AUTO && !t.isResetting && r(t, i, H)
                    : (a.code && b("Error: ".concat(a.code, ".")), r(t, i, H));
                } else
                  a.code
                    ? (r(t, i, H), g("Error: ".concat(a.code), 3076))
                    : r(t, i, !1);
                break;
              }
              case "feedbackInit": {
              ...
              case "requestFeedbackData": {
                var ee,
                  Oe = t.shadow.querySelector("#".concat(i));
                Oe ||
                  g(
              ...
              case "turnstileResults": {
                var B,
                  te,
                  le =
                    (B = t.wrapper.parentNode) === null || B === void 0
                      ? void 0
                      : B.querySelector("#".concat(i, "-fr"));
                le ||
                  g(
                    "Received state for an unknown widget: ".concat(a.widgetId),
                    3078
                  ),
                  (te = le.contentWindow) === null ||
                    te === void 0 ||
                    te.postMessage(
                      {
                        source: P,
              ...
              case "closeFeedbackReportIframe": {
                var re,
                  he =
                    (re = t.wrapper.parentNode) === null || re === void 0
                      ? void 0
                      : re.querySelector("#".concat(i, "-fr"));
                he ||
                  g(
                    "Received state for an unknown widget: ".concat(a.widgetId),
                    3078
              ...
              case "interactiveTimeout": {
                ...
                if (
                  (ue
                    ? ue()
                    : t.params["refresh-timeout"] === ie.NEVER &&
                      !t.isResetting &&
                      b(
              ...
              case "interactiveBegin": {
                ...
                Ce ||
                  ...
                  (be = t.cbBeforeInteractive) === null ||
                    be === void 0 ||
                    be.call(t),
                  t.params.appearance === X.INTERACTION_ONLY && Nt(Ce, t);
                break;
              }
              case "interactiveEnd": {
                var Ee;
                (Ee = t.cbAfterInteractive) === null ||
                  Ee === void 0 ||
                  Ee.call(t);
                break;
              }
                    ...
                    Fe(
                      {
                        ...
                        timeRenderMs:
                          t.widgetRenderEndTimeMs - t.widgetRenderStartTimeMs,
                        timeToInitMs:
                          t.widgetInitStartTimeMs - t.widgetRenderEndTimeMs,
                        timeToParamsMs:
                          t.widgetParamsStartTimeMs - t.widgetInitStartTimeMs,
                        tiefTimeMs: Te,
                      },
                      Ke
                    ),
    ...
    function R(_) {
      ...
      return V(_, Element)
        ? h(_)
        : _ || y.widgetMap.size === 0
        ? null
        : y.widgetMap.keys().next().value;
    }
    var M = {};
    return rt(Fe({}, M), {
      ready: function (a) {
        if (
          (y.scriptWasLoadedAsync &&
            (b(
          ...
          typeof a != "function" &&
            g(
              'turnstile.ready() expected a "function" argument, got "'.concat(
                typeof a == "undefined" ? "undefined" : U(a),
                '"'
              ),
              3841
            ),
      ...
      execute: function (a, i) {
        ...
        if (u) {
          ...
          u.isExpired &&
            ...
            u.isStale && (s(m), (u.isExecuting = !0)),
            u.msgQueue.push(oe.EXECUTE),
            (u.isExecuted = !0);
          ...
          if (
            ...
            return;
          if (
            (u.isInitialized && f(u, t, x),
            u.isInitialized && u.params.appearance === X.EXECUTE && Nt(x, u),
            u.isExecuting)
          ) {
            var A,
              S = u.shadow.querySelector("#".concat(m));
            S || g("Received state for an unknown widget: ".concat(t), 3078),
              (A = S.contentWindow) === null ||
                A === void 0 ||
                A.postMessage(
                  { source: P, widgetId: t, event: "execute" },
                  "*"
                );
          }
        }
      ...
      getResponse: function (a) {
        ...
        if (typeof a == "undefined") {
          ...
          if (t) {
            ...
            return (
              ...
              (d = y.widgetMap.get(t)) === null || d === void 0
                ? void 0
                : d.response
            );
        ...
        return (
          ...
          (i = y.widgetMap.get(m)) === null || i === void 0
            ? void 0
            : i.response
        );
      },
  ...
  function Hr(e) {
    ...
    c &&
      (it(c)
        ? (n.theme = c)
        : b('Unknown data-theme value: "'.concat(c, '".')));
    var l = e.getAttribute("data-size");
    if (
      (l &&
        (dt(l)
          ? (n.size = l)
          : b('Unknown data-size value: "'.concat(l, '".'))),
      0)
    )
      var h;
    ...
    i
      ? (Kt(i) ||
          b(
            'Invalid data-feedback-enabled value: "'.concat(
              i,
              ", expected either: 'true' or 'false'. Value is ignored."
            )
          ),
        (n["feedback-enabled"] = i === "true"))
      : (n["feedback-enabled"] = !0);
    var t,
      d =
        (t = e.getAttribute("data-response-field")) !== null && t !== void 0
          ? t
          : "true";
  ...
  function Br() {
    ...
    Ot(y, e),
      ...
      gr(window.turnstile, y);
  }
  (ve = !1),
    (O = dr()),
    (y.scriptWasLoadedAsync =
      (ze = O == null ? void 0 : O.loadedAsync) !== null && ze !== void 0
        ? ze
        : !1),
    (y.scriptUrl =
      (Ge = O == null ? void 0 : O.src) !== null && Ge !== void 0
        ? Ge
        : "undefined"),
    O != null &&
      O.params &&
      ((me = O.params.get("compat")),
      (me == null ? void 0 : me.toLowerCase()) === "recaptcha"
        ? window.grecaptcha
          ? b(
              "grecaptcha is already defined. The compatibility layer will not be enabled."
            )
          : (b("Compatibility layer enabled."),
            (y.isRecaptchaCompatibilityMode = !0),
            (window.grecaptcha = Mt))
        : me !== null &&
          b('Unknown value for api.js?compat: "'.concat(me, '", ignoring.')),
      O.params.forEach(function (e, r) {
        L(["onload", "compat", "_cb", "_upgrade", "_reload", "render"], r) ||
          b(
      ...
      (ve = O.params.get("_upgrade") === "true"),
      (z = O.params.get("onload")),
      z &&
        !ve &&
        setTimeout(function () {
    ...
    kt && !ve
      ...
      : (kt &&
          ...
          It(y),
          (O == null || (Xe = O.params) === null || Xe === void 0
            ? void 0
            : Xe.get("render")) !== "explicit" && setTimeout(Lt, 0)),
        (window.turnstile = Mt),
        ve ||
          ((O == null || (Ye = O.params) === null || Ye === void 0
            ? void 0
            : Ye.get("render")) !== "explicit" && Ft.push(Lt),
          document.readyState === "complete" ||
          document.readyState === "interactive"
            ? setTimeout(yr, 0)
            : window.addEventListener("DOMContentLoaded", yr))),
    (Er = 24 * 60 * 60 * 1e3),
    window.setTimeout(Br, Er);
